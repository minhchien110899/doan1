...
<div class="container">
	<div class="card my-3">
      ...
      <div class="card-body">	
        ...
        @endphp
        <div>
			<h5 class="font-weight-bold">Câu {{++$key}}: {{ $question->content }}&nbsp;<a href="#" data-toggle="modal" data-target="#del_question{{$key}}"><i class="fas fa-trash text-danger"></i></a>
  ...
  <h4><a href="{{ route('inspector.testexam') }}" style="margin-bottom: 30px !important;">&larr; Quay lại</a></h4>	
</div>
