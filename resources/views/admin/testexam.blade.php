                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row justify-content-between">
                            ...
                            <div class="col-4"><a href="#" class="btn btn-outline-success mr-1" data-toggle="modal"
                                    ...
                                    class="btn btn-outline-dark btn-sm mx-0 mt-2" data-toggle="modal"
                                                        ...
                                                        @if (count($trash_testexams) > 0)
                                                            @foreach ($trash_testexams as $key => $testexam)
                                                                <tr>
                                                                    <th scope="row">{{ ++$key }}</th>
                                                                    <td>{{ $testexam->name }}</td>
                                                                    <td><a href="{{ url('/admin/testexam/restore_trash', $testexam->id) }}"
                    ...
                    <div class="card-body">
                        <div class="row d-flex justify-content-end">
                          <div class="col-3 mb-2"><input type="text" class="form-control no-border-radius" id="myInput" onkeyup="myFunction()" placeholder="Tìm kiếm theo tên..." title="Type in a name"></div>
                          <div class="col-3 mb-2 pl-0"><input type="text" class="form-control no-border-radius" id="myInput1" onkeyup="myFunction1()" placeholder="Tìm kiếm theo môn..." title="Type in a subject"></div>
                        </div>
                                                ...
                                                <div class="modal fade" id="change_name{{ $key }}" tabindex="-1"
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        <div class="modal-content">
                                                            <div class="modal-body">
                                                                <form
                                                                    action="{{ url('/admin/testexam/change_name', $testexam->id) }}"
                                                                    method="POST">
                                                                    @csrf
                                                ...
                                                <div class="modal fade" id="del_testexam{{ $key }}" tabindex="-1"
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                <form
                                                                    action="{{ url('/admin/testexam/del_testexam', $testexam->id) }}"
                                                                    method="POST">
                                                                    @csrf
